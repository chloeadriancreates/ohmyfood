...
export default function Like() {
    return (
        <button className="like">
            <svg className="like_heart like_heart--hover" width="22" height="22" viewBox="0 0 22 22">
                <defs>
            ...
            <svg className="like_heart like_heart--regular" width="22" height="22" viewBox="0 0 22 22">
